...
if (isset($_GET['pageno'])) {
        ...
        $ress = mysqli_query($db,"SELECT * FROM `loan_apply` WHERE `status`='recovery officer' ORDER BY id DESC");
        $newloanquery =  mysqli_query($db,"SELECT * FROM `loan_apply` WHERE `status`='recovery officer' ORDER BY id DESC LIMIT $offset, $no_of_records_per_page");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Recovery Officer</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Responding</a></li>
                                <li ><a href="#Situational">Situational</a></li>
                                <li ><a href="#Intentional">Intentional</a></li>
                                <li ><a href="#Connectivity">Connectivity issue</a></li>
        ...
        <tbody>
                                   ...
                                   ?>
                                    <tr>
                                        ...
                                        <td data-title="Status" style="color:white; background:<?php if($user_status == "default"){echo "red;";}elseif($user_status == "disbursal"){echo "green;";}else{echo "blue;";}?>"><?=$user_status?></td>
