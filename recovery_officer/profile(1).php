...
if(isset($_POST['validation'])){
    ...
    if($sendmail == "ok"){
        ...
        /*print_r($_POST['processcheck']);
       $validation = explode(",",$validation);
       array_pop($validation);*/
       #$validation = implode("<br>",$extract);
...
$headers .= 'From: <docs@rush4cash.in>' . "\r\n";
$to=$userpro_email;
$subject="rush4cash application submitted";
$message=" Dear $userpro_name , we are waiting to disburse your loan. Please send your pending documents to docs@rush4cash.in for quick disbursal <br>
$validation
<br>
Thanks - Team rush4cash.in";
...
curl_setopt($ch, CURLOPT_POSTFIELDS,
            "senderid=RSALRY&message=".$message."&number=".$userpro_mobile."&apikey=rush4cash@sms");
...
<option value="cheque" <?php if($userpro_get_salary == "cheque"){echo "selected";}?>>cheque</option>
                                                            ...
                                                            <div class="form-group">
                                                                <lable>Gender</lable>
                                                                <input name="marital_status" type="text" class="form-control" value="<?=$userpro_marital_status;?>" placeholder="Gender" pattern="(?=.*[a-zA-Z]).{1,}" disabled>
                                                            </div>
                                                            <!--<div class="form-group">
                                                                <lable>Gender</lable>
        ...
        <tbody>
                                   ...
                                   ?>
                                    <form action="" method="post"><tr>
                                        ...
                                        <td><?php if(($users_status == 'pending')
){echo "applied";}else{echo $users_status;} ?></td>
                                        <td><?=$users_status_date?><input type="hidden" name="cllid" value="<?=$users_id;?>"></td>
                                        <td><input type="submit" class="btn btn-primary" name="loandata" value="save">
