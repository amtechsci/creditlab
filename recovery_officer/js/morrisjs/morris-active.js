// Dashboard Morris charts — only init when the target element exists (e.g. not on profile.php).

(function () {
	function initAreaChart(elementId, config) {
	...
	initAreaChart('morris-area-chart', {
		data: [{
			period: '2012',
			Python: 0,
			PHP: 0,
	...
	initAreaChart('extra-area-chart', {
		data: [{
			period: '2010',
			CSE: 50,
			Accounting: 80,
