...
if (isset($_GET['pageno'])) {
        ...
        $ress = mysqli_query($db,"SELECT * FROM user WHERE verify=1 ORDER BY id DESC");
        $usersquery =  mysqli_query($db,"SELECT * FROM user WHERE verify=1 AND status='Approved' ORDER BY id DESC LIMIT $offset, $no_of_records_per_page");
