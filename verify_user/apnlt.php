...
if (isset($_GET['pageno'])) {
        ...
        $ress = mysqli_query($db,"SELECT *
FROM user
WHERE `sloan` > 0 AND status='cleared' ORDER BY user.id DESC");
     
        $usersquery =  mysqli_query($db,"SELECT *
FROM user
WHERE `sloan` > 0 AND status='cleared' ORDER BY user.id DESC LIMIT $offset, $no_of_records_per_page");
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">All Users</a></li>
