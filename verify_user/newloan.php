...
if (isset($_GET['pageno'])) {
        ...
        $ress = mysqli_query($db,"SELECT * FROM `loan_apply` WHERE `status`='pending' ORDER BY id DESC");
        $newloanquery =  mysqli_query($db,"SELECT * FROM `loan_apply` WHERE `status`='pending' ORDER BY id DESC LIMIT $offset, $no_of_records_per_page");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Applied Loans</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Applied Loans</a></li>
        ...
        <tbody>
                                   ...
                                   ?>
                                    <tr>
                                        ...
                                        <td data-title="Name"><?=$users_name?><?php if($users_loan > 0){echo "<span style='color:red'>#</span>";}?><?php if($users_sloan > 0){echo "<span style='color:red'>@</span>";}?><?php if(empty($user_conpanydocument) or empty($user_personaldocument) or empty($user_salarydocument) or empty($user_bankdocument) or empty($user_addressdocument) or empty($user_companyidcard)){}else{echo " <span style='color:green; font-size:18px;'>✔</span>";}?></td>
                                        <td data-title="Email"><?=maskEmail($users_email)?></td>
                                        <td data-title="Mobile"><?=maskPhone($users_mobile)?></td>
                                        <td data-title="Status" style="color:white; background:<?php if($users_status == "default"){echo "red;";}elseif($users_status == "disbursal"){echo "green;";}else{echo "blue;";}?>"><?php if($users_status == "waiting"){echo "Just Register";}else{echo $users_status;}?></td>
