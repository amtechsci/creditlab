...
if(isset($_GET['id'])){
    $id = towreal($_GET['id']);
$loan  = towquery("SELECT loan_apply.*,user.name,user.father_name,user.permanent_address,user.mobile,user.altmobile,user.email,user.signature,user.aadhar,user.personaldocument,user.conpanydocument,user.pan,user.marital_status FROM `loan_apply` INNER JOIN user
