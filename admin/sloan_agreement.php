...
$b = $loanf;
             ...
             $salary_date = $user_a['salary_date'];
            //  print_r("SELECT * FROM loan WHERE lid=".$b['id']);
             $processed_date = date_create(date('Y-m-d H:i:s'));
