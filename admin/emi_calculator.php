...
if (isset($_POST['amount'], $_POST['salary_date'], $_POST['processed_date'])
    && $_POST['amount'] !== ''
    && $_POST['salary_date'] !== ''
    && $_POST['processed_date'] !== '') {
             $loan_amountc = (float) towreal($_POST['amount']);
             $salary_date = towreal($_POST['salary_date']);
             $processed_date = date_create(towreal($_POST['processed_date']));
             if ($processed_date instanceof DateTimeInterface) {
             $dis_date = date_format($processed_date,"Y-m-d");
             $dis_day = date_format($processed_date,"Y-m");
             $sal_day_dt = date_create($dis_day."-".$salary_date);
             if ($sal_day_dt instanceof DateTimeInterface) {
             $sal_day = date_format($sal_day_dt,"Y-m-d");
