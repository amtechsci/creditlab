...
if (isset($_GET['pageno'])) {
        ...
        $usersquery =  mysqli_query($db,"SELECT * FROM user WHERE verify=3 OR verify=4 ORDER BY id DESC LIMIT $offset, $no_of_records_per_page");
        ...
        <tbody>
                                   ...
                                   <?php $ii=1; while($loanfetch = towfetch($usersquery)){ extract($loanfetch,EXTR_PREFIX_ALL,"users"); ?>
                                    <tr>
                                        ...
                                        <td data-title="Name"><?=$users_name?><?php if($users_verify == 3){echo "<span style='color:green'>+</span>";}?><?php if($users_verify == 4){echo "<span style='color:red'>-</span>";}?></td>
