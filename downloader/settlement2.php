...
// SQL query to fetch data for loan settlement transactions (transaction_flow = 'settlement')
$sql = "SELECT u.name, u.dob, u.gender, u.pan, u.mobile, u.email, u.present_address, u.state_code, u.pincode, u.rcid, 
        ...
        WHERE td.transaction_flow = 'settlement'"; // Filter for settlement transactions
...
while ($row = towfetch($result)) {
    ...
    $data = [
        ...
        '',                         // Date Closed
        $transaction_date,          // Date Reported (settlement date)
        ...
        '0',                        // Suit Filed / Wilful Default (No for settlements)
        '04',                       // Credit Facility Status (Assume '04' for settled loans)
        '03',                       // Asset Classification (Assume '03' for sub-standard loans)
        '',                         // Value of Collateral
        '',                         // Type of Collateral
        '',                         // Credit Limit
        '',                         // Cash Limit
        ...
        $row['transaction_amount'], // Settlement Amt (settlement amount)
        '',                         // Payment Frequency
        $row['transaction_amount'], // Actual Payment Amt (settlement amount)
        '',                         // Occupation Code
        '',                         // Income
