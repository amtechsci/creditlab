...
if($b['days'] > 30){
            ...
            // if($day_gap > 15){
            // }else{
            //      $femi_date = date('Y-m-d', strtotime( $femi_date . " +1 month"));
            //      $semi_date = date('Y-m-d', strtotime( $femi_date . " +1 month"));
            // }
            ...
            //  }
                    ...
                    //     if(townum($check) == 1){
                    //     }else{
                    //     $extraday = $lessday - $today;
                    //     $extradaya = round($extraday / (60 * 60 * 24));
                    //     $penalty = $extradaya*50;
                    //     towquery("UPDATE `loan` SET `penality_charge`='$penalty' WHERE `lid`='".$b['penality_charge']."'");
                    //     }
                    // }else{
                    // $penalty=0;
                    // }
...
<div class="container">
    <center>
<DIV id="page_1">
<img src="/letterhead1.jpg" style="width:100%;">
<DIV id="id1_1">
<P class="p0 ft0">Loan Agreement</P>
<P class="p1 ft2">This LOAN AGREEMENT (“<SPAN class="ft1">Agreement</SPAN>”) is being entered into this on <NOBR><SPAN class="ft1"><?=date("d-m-Y", strtotime($loanf['status_date']))?></SPAN></NOBR><SPAN class="ft1"> </SPAN>(“<SPAN class="ft1">Execution Date</SPAN>”) between</P>
...
<div style="overflow:hidden;"><img src="<?=getAppUrl()?>/user/uploads/<?=$loanf['signature']?>" width="150" style="float:right;" height="100"></div>
</DIV>
<DIV id="id1_2">
...
<P class="p24 ft2"><SPAN class="ft3">2.</SPAN><SPAN class="ft16">Number of EMIs: 2 structured EMIs as follows:</SPAN></P>
</DIV>
<DIV id="id2_2">
...
<P class="p130 ft27"><SPAN class="ft2">(a)</SPAN><SPAN class="ft28">He/she has read all the terms and conditions (<?=getAppUrl()?>/terms.php), privacy policy (<?=getAppUrl()?>/privacy.php), and other material available at the website of creditlab (https://creditlab.in/).</SPAN></P>
...
<div style="overflow:hidden;"><img src="<?=getAppUrl()?>/user/uploads/<?=$aadharfile[0]?>" style="width:100%;height:!00%;"></div>
<div style="overflow:hidden;"><img src="<?=getAppUrl()?>/user/uploads/<?=$aadharfile[1]?>" style="width:100%;height:!00%;"></div>
<div style="overflow:hidden;"><img src="<?=getAppUrl()?>/user/uploads/<?=$loanf['conpanydocument']?>" style="width:100%;height:!00%;"></div>
</div>
</div>
</body>
</html>