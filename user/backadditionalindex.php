...
if(isset($_POST['graduation_year'])){
    ...
    extract($extract);
    $freq_app = towrealarray($_POST['freq_app']);
    if($freq_app){
    $freq_app = implode(" ",$freq_app);
    }else{ $freq_app = "none";}
    towquery("UPDATE `user` SET `graduation_year`='$graduation_year',`marital_status`='$marital_status',`college_name`='$college_name',`freq_app`='$freq_app',`experience`='$experience',`residence_type`='$residence_type',`credit_card`='$credit_card' WHERE email='$user'") and print_r("<script>window.location.replace('index.php');</script>");
}
    ?>
            <!-- Mobile Menu end -->
            ...
            <div class="container-fluid">
              ...
              <label class="containeri" style="float:left;"> &nbsp;&nbsp;&nbsp; Unmarried 
                ...
                <span class="checkmark"></span>
                                                            ...
                                                            <br>
                                                            <div class="form-group">
                            <input class="form-control col-xs-12 col-sm-12 pull-left" placeholder="College Name of your last education" name="college_name" id="clg_name_list"  style = "width:100%;" required>
                                                            </div>
  ...
  <div class="col-md-12 ">
                  ...
                  <option value="Hostel">Hostel</option></select>
                            ...
                            <option value="None">None</option>
                                                    ...
                                                    <center><p style="color:red" id="check"></p><button class="btn btn-primary">Submit</button></center>
                                                    </form>
                                                <?php } ?>
                                </div>
            </div>
...
$(document).ready(function(){
 ...
 if ($('input:checkbox').filter(':checked').length < 1){
        $("#check").html("mark at least one app");
 return false;
 }else{
     $("#check").html("");
 }
