...
<div style="overflow:hidden;"><img src="../user/file.php?f=<?=$aadharfile[0]?>" style="width:100%;height:!00%;"></div>
<div style="overflow:hidden;"><img src="../user/file.php?f=<?=$aadharfile[1]?>" style="width:100%;height:!00%;"></div>
<div style="overflow:hidden;"><img src="../user/file.php?f=<?=$loanf['conpanydocument']?>" style="width:100%;height:!00%;"></div>
</div>
</div>
</body>
</html>